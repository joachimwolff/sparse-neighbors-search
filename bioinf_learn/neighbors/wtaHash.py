...
class WtaHash():
    ...
    def __init__(self, n_neighbors = 5, radius = 1.0, fast=False, number_of_hash_functions=400, rangeK_wta=10,
        ...
        self._nearestNeighborsCppInterface = NearestNeighborsCppInterface(n_neighbors=n_neighbors, radius=radius,
                ...
                cpu_gpu_load_balancing=cpu_gpu_load_balancing, gpu_hashing=gpu_hashing, rangeK_wta=rangeK_wta)
