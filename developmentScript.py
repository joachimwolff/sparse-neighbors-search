...
def test(data):
    ...
    minHash = MinHash(number_of_hash_functions=400, shingle_size = 1, similarity=False, bloomierFilter=False, number_of_cores=2, prune_inverse_index=-1, 
                    prune_inverse_index_after_instance=-1, removeHashFunctionWithLessEntriesAs=-1, hash_algorithm = 1)
    # minHash.fit(data[0])
