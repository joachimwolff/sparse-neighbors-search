...
def test(data):
    ...
    minHash = MinHash(number_of_hash_functions=800, block_size = 1, similarity=True, bloomierFilter=True, number_of_cores=4)
    # minHash.fit(data[0])
    ...
    minHash2 = MinHash(number_of_hash_functions=800,block_size = 1, similarity=True, bloomierFilter=False, number_of_cores=4)
    # minHash.fit(data[0])
    time_fit = time.time()
