...
def test(data):
    ...
    minHash = MinHash(number_of_hash_functions=400, shingle_size = 4, similarity=False, bloomierFilter=False, number_of_cores=4, prune_inverse_index=50, 
                    prune_inverse_index_after_instance=-1, removeHashFunctionWithLessEntriesAs=-1, hash_algorithm = 0, shingle=1, block_size=5)
    # minHash.fit(data[0])
    ...
    minHash2 = MinHash(number_of_hash_functions=400, shingle_size = 4, similarity=False, bloomierFilter=False, number_of_cores=2, prune_inverse_index=-1, 
                    prune_inverse_index_after_instance=-1, removeHashFunctionWithLessEntriesAs=-1, hash_algorithm = 0, shingle=2, block_size=5)
    # minHash.fit(data[0])
    time_fit = time.time()
